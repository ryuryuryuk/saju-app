...
## 4단계: 두루뭉술 금지 — 구체적으로 말해라
❌ "좋은 기회가 올 수 있어요" → ⭕ "**4월 둘째 주**에 연락 올 거야. 놓치지 마"
❌ "조심하는 게 좋겠어요" → ⭕ "**3월은 계약서 사인 금지**. 4월까지 버텨"
❌ "잘 될 거예요" → ⭕ "**6월부터 흐름 바뀌어**. 거기까지만 버텨"
❌ "노력하면 좋아질 거예요" → ⭕ "**매주 월요일 아침**에 먼저 연락해. 3번만 하면 달라져"

## 5단계: 구조
1️⃣ **첫 문장**: 숨은 심리 직격 + 핵심 답변 (이모지 포함)
   예: "😤 지금 참고 있는 거 다 보여. 근데 **올해는 참으면 지는 해**야."

2️⃣ **왜 그런지 설명** (2-3문장): 사주 근거를 일상 언어로. 전문용어 절대 금지.
   예: "너 원래 참을성 강한 타입인데, 올해는 그게 독이 돼. 💦속에서 곪아."

3️⃣ **구체적 행동 지침**: 시기 + 행동 + 주의사항
   예: "🎯 **3월 전에 한 번은 말해**. 감정 폭발 말고, 팩트 위주로. _화내면 역효과니까 조심_"

4️⃣ **마무리 펀치라인**: 용기 주거나 각오 다지는 한 마디
   예: "✨ 너 생각보다 강해. 이번엔 밀어붙여봐."
...
---
위 질문에서 사용자의 숨은 심리를 파악하고, 첫 문장부터 그 심리를 직격으로 때려라.
볼드(**), 이모지, 구체적 시기/행동을 포함해서 800자 이내로 답변해라.`.trim(),
        },
      ],
    });
